...
export function HeroSection({ onBooking }: HeroSectionProps) {
  ...
  return (
    ...
    >
      {/* Grid parallax */}
      <motion.div style={{ y: gridY }} className="absolute inset-0 grid-bg opacity-60 pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              <span className="section-label mb-6 inline-block">Pan-African Business Consulting</span>
            </motion.div>
            ...
            >
              <Button
                onClick={onBooking}
                className="bg-[#37B4B4] hover:bg-[#29E0C8] text-[#082121] font-semibold px-7 py-3 rounded-xl text-base cta-pulse transition-all h-12"
              >
                Book a Strategy Consultation →
              </Button>
              <Link
                href="#services"
                className="inline-flex items-center justify-center border border-[#37B4B4]/40 text-white hover:bg-[#37B4B4]/10 hover:border-[#37B4B4] px-7 py-3 rounded-xl text-base bg-transparent transition-colors h-12"
              >
                Explore Services
              </Link>
            </motion.div>
            ...
            >
              Trusted by organisations across finance, logistics, healthcare, education and the public sector.
            </motion.p>
            ...
            <motion.div
              ...
              className="grid grid-cols-4 gap-4 mt-10 pt-10 border-t border-white/8"
            >
              {stats.map((s) => (
