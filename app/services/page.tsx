...
export default function ServicesPage() {
  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen">
      ...
      {/* Directory Hero */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-[#0E3E3E] text-white text-center px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-xl text-white/70 leading-relaxed font-light max-w-2xl mx-auto">
             16 integrated service lines designed to modernise Pan-African enterprise operations from the ground up.
          </p>
        </div>
      </section>
